            ...
            <div class="flex items-center gap-4">
                <div class="relative has-tooltip group h-9 flex items-center">
                    ...
                    <button
                        ...
                        class="h-full flex items-center gap-3 px-4 bg-white/5 rounded-full border border-white/5 cursor-not-allowed opacity-70 hover:bg-white/10 transition-colors text-[10px] font-black uppercase tracking-widest"
                    >
                ...
                <button
                    ...
                    class={`h-9 px-4 rounded-full text-[10px] font-black uppercase tracking-widest transition-all duration-300 border flex items-center justify-center ${isAdvanced()
