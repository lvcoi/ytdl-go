...
This comprehensive reference documents all command-line flags available in ytdl-go. For quick usage examples, see the [Basic Downloads](../user-guide/usage/basic-downloads) guide.
...
See the complete [Output Placeholders](output-placeholders) reference for all available placeholders and detailed examples.
...
> **Warning:** This flag is currently **not implemented** and has no effect. It is reserved for future versions that will support downloading playlist entries in parallel. Check the project's GitHub issues for implementation status.
...
> **Tip:** You can safely omit this flag; behavior is always sequential in the current version.
...
> **Warning:** For security reasons, you should normally bind the web server only to localhost (`127.0.0.1`) unless you fully understand the risks and have additional protections (such as host allowlisting and a reverse proxy) in place.
...
- [Output Placeholders](output-placeholders) - Complete template placeholder reference
- [Exit Codes](exit-codes) - Program exit codes for scripting
- [Basic Downloads](../user-guide/usage/basic-downloads) - Getting started guide
- [Troubleshooting](../user-guide/troubleshooting) - Problem solving guide
- [Developer Guide](../developer-guide) - Contributing to ytdl-go
